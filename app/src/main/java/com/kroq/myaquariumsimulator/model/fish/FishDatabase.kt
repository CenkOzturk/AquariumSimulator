...
object FishDatabase {
    private val fishes = listOf(
        ...
        FishModel(104, R.string.fish_104_name, R.drawable.fish_05, 300, 8,FishMoveModel(450f, 350f, 100f, 200f, 1f, 1, ), requirementType = RequirementType.BRONZE),
        FishModel(105, R.string.fish_105_name, R.drawable.fish_06, 500, 12,FishMoveModel(80f, 420f, 100f, 200f, 1.3f, -1), requirementType = RequirementType.BRONZE),
        FishModel(106, R.string.fish_106_name, R.drawable.fish_07, 800, 18,FishMoveModel(320f, 220f, 100f, 200f, 1.1f, 1, ), requirementType = RequirementType.BRONZE),

        FishModel(107, R.string.fish_107_name, R.drawable.fish_08, 1300, 26,FishMoveModel(260f, 580f, 100f, 200f, 0.9f, -1), requirementType = RequirementType.SILVER),
        FishModel(108, R.string.fish_108_name, R.drawable.fish_09, 2000, 38,FishMoveModel(410f, 300f, 100f, 200f, 1.4f, 1, ), requirementType = RequirementType.SILVER),
        FishModel(109, R.string.fish_109_name, R.drawable.fish_10, 3200, 55,FishMoveModel(140f, 120f, 100f, 200f, 1.0f, -1), requirementType = RequirementType.SILVER),
        ...
        FishModel(111, R.string.fish_111_name, R.drawable.fish_12, 8000, 115,FishMoveModel(230f, 360f, 100f, 200f, 0.85f, -1), requirementType = RequirementType.GOLD),
        FishModel(112, R.string.fish_112_name, R.drawable.fish_13, 12500, 165,FishMoveModel(360f, 180f, 100f, 200f, 1.35f, 1, ), requirementType = RequirementType.GOLD),
